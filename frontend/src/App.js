        ...
        <div className="sidebar">
          ...
          <nav className="sidebar-nav">
            <ul>
              ...
              <li><button className={currentPage === 'role_management' ? 'active' : ''} onClick={() => setCurrentPage('role_management')}>Role Access Control</button></li>
              <li><button className={currentPage === 'activity_log' ? 'active' : ''} onClick={() => setCurrentPage('activity_log')}>Activity Logs</button></li>
              <li><button className={currentPage === 'db_config' ? 'active' : ''} onClick={() => setCurrentPage('db_config')}>DB Configuration</button></li>
              <li><button className={currentPage === 'alert_system' ? 'active' : ''} onClick={() => setCurrentPage('alert_system')}>Alert System</button></li>
          ...
          <div className="cbba-status">
            CBBA: <span className={lastCbbaScore !== null && lastCbbaScore < 0 ? 'anomaly' : 'normal'}>
                    {cbbaStatus}
                  </span>
            {lastCbbaScore !== null && <span> (Score: {lastCbbaScore.toFixed(4)})</span>}
          </div>
        </div>
      )}
